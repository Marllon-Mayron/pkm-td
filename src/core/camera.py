...
class Camera:
    ...
    def world_to_screen(self, world_x, world_y):
        ...
        return render_context.world_to_screen(world_x, world_y, self, self.screen_manager)

    def get_scale(self):
        """Retorna escala atual"""
        return render_context.get_scale(self, self.screen_manager)